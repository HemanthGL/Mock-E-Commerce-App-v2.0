...
import { sortByPriceHTL, sortByPriceLTH, sortByRating, sortByReviewCount, sortFunctionHelper } from "../services/sort-filters.js";
...
arr.forEach((ele) => sortFunctionHelper(ele[0], ele[1], products, HOME_ALL_CARDS));
